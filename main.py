...
BOT_TOKEN = "7510811043:AAGn2PqfJDv_n9PnZ_g6cWmYd4gXiOrNqJ4"
PAYMENT_CHANNEL = "@NIHALPAYMENT" #add payment channel here including the '@' sign
OWNER_ID = 6286497370 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@NIHALFFSTORE"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
